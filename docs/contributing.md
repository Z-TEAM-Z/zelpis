...
1. **报告问题**：在 GitHub Issues 中报告 bug 或提出新功能建议
2. **提交代码**：通过 Pull Request 提交代码修改
3. **改进文档**：完善项目文档，包括 API 文档、使用指南等
4. **回答问题**：在 GitHub Issues 或社区中回答其他用户的问题
5. **分享经验**：在博客、社交媒体等平台分享您使用 Zelpis 的经验
...
Add ability to pass custom render options to boot function
