...
| `validateHtml` | `false \| 'warn' \| 'strict'` | ❌ | HTML 校验级别，默认为 `'warn'`。详见 [HTML 校验](#html-校验) |
...
- **时间紧急** - 可以设置 `validateHtml: false` 暂时跳过校验
